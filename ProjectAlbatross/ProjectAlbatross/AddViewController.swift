...
//            let timestamp = (Date().timeIntervalSince1970 as NSString).doubleValue
            ...
            let utcTimeZoneDouble = Double(theDate.timeIntervalSinceReferenceDate)
            
            let nineStat = masterNine(name: name, birdies: Int(((textBoxContainer.subviews[6] as? statField)?.rawValue)!)!, putts: Int(((textBoxContainer.subviews[1] as? statField)?.rawValue)!)!, short: Int(((textBoxContainer.subviews[7] as? statField)?.rawValue)!)!, hundo: Int(((textBoxContainer.subviews[2] as? statField)?.rawValue)!)!, greens: Int(((textBoxContainer.subviews[3] as? statField)?.rawValue)!)!, score: Int(((textBoxContainer.subviews[5] as? statField)?.rawValue)!)!, sneaks: Int(((textBoxContainer.subviews[4] as? statField)?.rawValue)!)!, fairways: Int(((textBoxContainer.subviews[0] as? statField)?.rawValue)!)!, date: date, opponentScore: Int(((textBoxContainer.subviews[9] as? statField)?.rawValue)!)!, opponentName: ((textBoxContainer.subviews[8] as? statField)?.rawValue)!, timeStamp: utcTimeZoneDouble)
            ...
            let eighteenStat = masterEighteen(name: name, birdsFront: Int(((textBoxContainer.subviews[5] as? statField)?.text)!)!, puttsFront: Int(((textBoxContainer.subviews[6] as? statField)?.text)!)!, shortFront: Int(((textBoxContainer.subviews[2] as? statField)?.text)!)!, hundoFront: Int(((textBoxContainer.subviews[3] as? statField)?.text)!)!, greensFront: Int(((textBoxContainer.subviews[1] as? statField)?.text)!)!, scoreFront: Int(((textBoxContainer.subviews[7] as? statField)?.text)!)!, sneaksFront: Int(((textBoxContainer.subviews[4] as? statField)?.text)!)!, fairwaysFront: Int(((textBoxContainer.subviews[0] as? statField)?.text)!)!, birdsBack: Int(((textBoxContainer.subviews[13] as? statField)?.text)!)!, puttsBack: Int(((textBoxContainer.subviews[10] as? statField)?.text)!)!, shortBack: Int(((textBoxContainer.subviews[14] as? statField)?.text)!)!, hundoBack: Int(((textBoxContainer.subviews[11] as? statField)?.text)!)!, greensBack: Int(((textBoxContainer.subviews[9] as? statField)?.text)!)!, scoreBack: Int(((textBoxContainer.subviews[15] as? statField)?.text)!)!, sneaksBack: Int(((textBoxContainer.subviews[12] as? statField)?.text)!)!, fairwaysBack: Int(((textBoxContainer.subviews[8] as? statField)?.text)!)!, date: date, opponentScore: 0, opponentName: "")
